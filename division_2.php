...
$sql_users = "SELECT id, name, position, email, division FROM users WHERE division = 'ICT Division'";
...
<head>
    ...
    <title>ICT Division Employees</title>
    ...
    <form id="selectForm" method="POST" action="process_selection.php">
        <div class="card-container">
            ...
            if ($stmt_users->rowCount() > 0) {
                ...
                echo "<p>No employees found in ICT Division.</p>";
            }
            ?>
        </div>
