...
$sql_users = "SELECT id, name, position, email, division FROM users WHERE division = 'Graphic communication & Training'";
...
<head>
    ...
    <title>Graphic communication & Training Employees</title>
    ...
    <form id="selectForm" method="POST" action="process_selection.php">
        <div class="card-container">
            ...
            if ($stmt_users->rowCount() > 0) {
                ...
                echo "<p>No employees found in Graphic communication & Training.</p>";
            }
            ?>
        </div>
